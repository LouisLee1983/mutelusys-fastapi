-- 数据库模型同步SQL语句
-- 生成时间: 2025-06-24 15:02:52.816005
-- 注意: 执行前请备份数据库!
...
CREATE TABLE cultural_trend_reports (
    ...
    report_type VARCHAR(9) NOT NULL DEFAULT 'daily',
...
-- 表: customer_segments (模型: CustomerSegment)
ALTER TABLE customer_segments ALTER COLUMN tags TYPE TEXT[];
...
CREATE TABLE duty_rules (
    ...
    category_id UUID,
    tax_free_amount REAL DEFAULT 0.0,
    tax_rate REAL NOT NULL,
    min_tax_amount REAL DEFAULT 0.0,
    max_tax_amount REAL,
...
CREATE TABLE duty_zones (
    id UUID NOT NULL DEFAULT gen_random_uuid(),
    name VARCHAR(100) NOT NULL,
    tax_free_threshold REAL DEFAULT 0.0,
...
ALTER TABLE currencies ADD COLUMN exchange_rate REAL DEFAULT 1.0;
ALTER TABLE currencies ADD COLUMN sort_order INTEGER DEFAULT 0;
...
CREATE TABLE affiliate_programs (
    ...
    commission_structure VARCHAR(17) NOT NULL,
    default_commission_rate REAL DEFAULT 10.0,
    min_commission_rate REAL DEFAULT 5.0,
    max_commission_rate REAL DEFAULT 30.0,
...
CREATE TABLE affiliates (
    ...
    override_program_rate BOOLEAN DEFAULT FALSE,
    cookie_days INTEGER DEFAULT 30,
    payment_method VARCHAR(50),
    payment_details JSONB,
    payment_threshold REAL DEFAULT 100,
    tax_id VARCHAR(50),
...
ALTER TABLE promotions ALTER COLUMN active_days TYPE TEXT[];
...
ALTER TABLE promotions ALTER COLUMN applicable_countries TYPE TEXT[];
ALTER TABLE promotions ALTER COLUMN excluded_countries TYPE TEXT[];
ALTER TABLE promotions ALTER COLUMN applicable_currencies TYPE TEXT[];
ALTER TABLE promotions ALTER COLUMN eligible_customer_groups TYPE TEXT[];
ALTER TABLE promotions ALTER COLUMN applicable_products TYPE TEXT[];
ALTER TABLE promotions ALTER COLUMN excluded_products TYPE TEXT[];
ALTER TABLE promotions ALTER COLUMN applicable_categories TYPE TEXT[];
ALTER TABLE promotions ALTER COLUMN excluded_categories TYPE TEXT[];
...
CREATE TABLE thematic_campaigns (
    ...
    featured_bundles TEXT[],
    featured_symbols TEXT[],
    featured_materials TEXT[],
    promotion_ids TEXT[],
...
CREATE TABLE order_status_history (
    ...
    is_customer_notified INTEGER DEFAULT 0,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id)
);
...
ALTER TABLE cash_on_delivery_settings ALTER COLUMN allowed_countries TYPE TEXT[];
ALTER TABLE cash_on_delivery_settings ALTER COLUMN excluded_postcodes TYPE TEXT[];
...
ALTER TABLE cash_on_delivery_settings ALTER COLUMN excluded_product_categories TYPE TEXT[];
ALTER TABLE cash_on_delivery_settings ALTER COLUMN excluded_products TYPE TEXT[];
ALTER TABLE cash_on_delivery_settings ALTER COLUMN max_product_weight TYPE REAL;
ALTER TABLE cash_on_delivery_settings ALTER COLUMN allowed_customer_groups TYPE TEXT[];
ALTER TABLE cash_on_delivery_settings ALTER COLUMN blacklisted_customers TYPE TEXT[];
ALTER TABLE cash_on_delivery_settings ALTER COLUMN allowed_shipping_methods TYPE TEXT[];
ALTER TABLE cash_on_delivery_settings ALTER COLUMN notification_emails TYPE TEXT[];
...
ALTER TABLE installment_plans ALTER COLUMN allowed_currencies TYPE TEXT[];
ALTER TABLE installment_plans ALTER COLUMN allowed_countries TYPE TEXT[];
ALTER TABLE installment_plans ALTER COLUMN allowed_customer_groups TYPE TEXT[];
ALTER TABLE installment_plans ALTER COLUMN allowed_product_categories TYPE TEXT[];
ALTER TABLE installment_plans ALTER COLUMN excluded_products TYPE TEXT[];
